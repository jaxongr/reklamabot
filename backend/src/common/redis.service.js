...
var RedisService = function () {
    ...
    var RedisService = _classThis = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    try {
                        ...
                        this.client.on('error', function (err) {
                            _this.logger.warn("Redis connection error: ".concat(err.message));
                        });
        ...
        RedisService_1.prototype.set = function (key_1, value_1) {
            return __awaiter(this, arguments, void 0, function (key, value, ttlSeconds) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.client.set(key, JSON.stringify(value), 'EX', ttlSeconds)];
                        case 2:
                            _b.sent();
                            return [3 /*break*/, 4];
                        case 3:
        ...
        RedisService_1.prototype.getOrSet = function (key_1, factory_1) {
            return __awaiter(this, arguments, void 0, function (key, factory, ttlSeconds) {
                var cached, value;
                if (ttlSeconds === void 0) { ttlSeconds = 300; }
                return __generator(this, function (_a) {
                    switch (_a.label) {
