...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
        ...
        PrismaService_1.prototype.cleanDatabase = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    models = Reflect.ownKeys(this).filter(function (key) { return typeof key === 'string' && key[0] !== '_' && key[0] !== '$'; });
                    return [2 /*return*/, Promise.all(models.map(function (modelKey) {
                            // @ts-expect-error - Dynamic model access
                            var model = _this[modelKey];
        ...
        PrismaService_1.prototype.executeTransaction = function (callback) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
