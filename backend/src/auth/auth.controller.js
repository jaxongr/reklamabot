...
var AuthController = function () {
    ...
    var _telegramWebApp_decorators;
    ...
    var AuthController = _classThis = /** @class */ (function () {
         ...
         */
        AuthController_1.prototype.adminLogin = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.adminLogin(body.username, body.password)];
                });
            });
        };
        /**
         ...
         */
        AuthController_1.prototype.telegramWebApp = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.telegramWebAppAuth(body.initData)];
                });
            });
        };
        /**
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.Post)('login'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Login via Telegram auth data' })];
        _adminLogin_decorators = [(0, common_1.Post)('admin-login'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Admin login with username and password' })];
        _telegramWebApp_decorators = [(0, common_1.Post)('telegram-webapp'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Auth via Telegram Mini App initData' })];
        ...
        __esDecorate(_classThis, null, _telegramWebApp_decorators, { kind: "method", name: "telegramWebApp", static: false, private: false, access: { has: function (obj) { return "telegramWebApp" in obj; }, get: function (obj) { return obj.telegramWebApp; } }, metadata: _metadata }, null, _instanceExtraInitializers);
