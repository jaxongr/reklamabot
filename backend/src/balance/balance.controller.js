...
var BalanceController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Balance'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.Controller)('balance'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard)];
    ...
    var BalanceController = _classThis = /** @class */ (function () {
        function BalanceController_1(balanceService) {
            this.balanceService = (__runInitializers(this, _instanceExtraInitializers), balanceService);
        }
        BalanceController_1.prototype.getBalance = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.balanceService.getBalance(req.user.userId)];
                });
            });
        };
        BalanceController_1.prototype.topUp = function (req, body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.balanceService.topUp(req.user.userId, body.amount, body.description)];
                });
            });
        };
        BalanceController_1.prototype.getTransactions = function (req, page, limit) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.balanceService.getTransactions(req.user.userId, page ? parseInt(page) : 1, limit ? parseInt(limit) : 20)];
                });
            });
        };
    ...
    (function () {
        ...
        _getBalance_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Balans olish' })];
        _topUp_decorators = [(0, common_1.Post)('top-up'), (0, swagger_1.ApiOperation)({ summary: "Balans to'ldirish" })];
        _getTransactions_decorators = [(0, common_1.Get)('transactions'), (0, swagger_1.ApiOperation)({ summary: 'Tranzaksiyalar tarixi' })];
