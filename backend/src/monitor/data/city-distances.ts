...
export const CITIES: CityCoord[] = [
  ...
  // --- Viloyat markazlari ---
  { name: 'Toshkent', aliases: ['toshkent', 'тошкент', 'ташкент', 'tashkent', 'ташк', 'тош', 'тошк', 'тошкен', 'ташкен', 'тошкенд', 'toshken', 'tashken', 'тошкант', 'тошканд', 'toshkant', 'tashkant', 'тоshkent', 'тошкет', 'тошкенг', 'тошкинт', 'тошкінт', 'toshket', 'tashket', 'towkent', 'towken', 'тошкенд', 'ташкенд', 'toshent', 'тошент', 'тошкэнт', 'ташкэнт', 'тошкэн', 'ташкэн', 'toshkeng', 'toshkin', 'тошкин', 'тошкін', 'towkin', 'ташкін', 'toshkint', 'тошкінт', 'toahkent', 'тоахкент', 'toshkentan', 'тошкентан', 'tawkent', 'tawken', 'тошкенада', 'тощкент', 'тошкедан', 'toshknt', 'тошкнт', 'toshkenta', 'тошконг', 'тошкон', 'тошконда', 'towkon', 'тошкетндан', 'toshen', 'тошкін', 'тошленда', 'toshlent', 'тошекнт', 'тошкенда', 'toshkon', 'тошкетн', 'тошкетнд', 'вокенит', 'тискент', 'tiskent', 'tiskend', 'towkand', 'тошкемт', 'toshkemt', 'toshkend', 'towkan', 'towkin', 'тоwкент', 'тоwкен', 'toskent', 'tosken', 'тоскент', 'тоскен', 'tashkon', 'ташкон', 'таошкен', 'таошкент', 'тоашкент'], lat: 41.2995, lng: 69.2401 },
  { name: 'Samarqand', aliases: ['samarqand', 'самарканд', 'самарқанд', 'samarkand', 'самар', 'samarqant', 'самарқант', 'самаркант', 'самаркан', 'samarkan', 'samarqon', 'самарқон', 'самарконд', 'samarkond', 'samarqond', 'самарқонд', 'самаркенд', 'samarkend', 'самарканда', 'самқанд', 'самрқанд', 'самаранд', 'samarqad', 'самаркад', 'самарқад', 'samarqan', 'самарқан', 'samarkad', 'самарканг', 'samarkang', 'samarqang', 'samarqat', 'самарқат', 'самаркат', 'samarkat', 'samarqam', 'самарқам', 'самаркам', 'samarkam', 'самкан', 'samkan', 'samrqat', 'самрқат', 'самркат', 'samarqnd', 'самарқнд', 'samarqa', 'самарқа', 'samarwand', 'самарткант', 'samarqamd', 'самрканд', 'самаркард', 'samarpadan', 'самарпадан', 'самарканддан', 'samrqand', 'самарқ', 'самарк', 'samarq', 'camarqand', 'camarkand', 'camarqan', 'camarkan', 'самарқанга', 'самарканга'], lat: 39.6542, lng: 66.9597 },
  { name: 'Buxoro', aliases: ['buxoro', 'бухара', 'бухоро', 'bukhara', 'бухар', 'buhoro', 'бухоро', 'бухоpо', 'bukhoro', 'букхара', 'бухаро', 'бухора', 'бухро', 'buxaro', 'буxоро', 'бухоро', 'buxora', 'буксора', 'бухсора', 'бухорга', 'boxoro', 'buxaraga', 'бухордан', 'бухарадан', 'бухрдан', 'buxordan'], lat: 39.7681, lng: 64.4556 },
  { name: 'Navoiy', aliases: ['navoiy', 'навои', 'navoi', 'навое', 'навоий', 'навоі', 'навой', 'navoiy', 'навоиий', 'навоїй', 'навоі', 'навоий', 'новоий', 'новои', 'novoy', 'новой', 'навоі', 'navoyi', 'novoiy', 'новоій', 'новоий', 'novoyi', 'новойи', 'навойі', 'новай', 'новайдан', 'новайи', 'навоиазот', 'navo', 'наво'], lat: 40.1003, lng: 65.3792 },
  { name: 'Andijon', aliases: ['andijon', 'андижан', 'andijan', 'андижон', 'андиж', 'анжон', 'anjón', 'anjon', 'андижан', 'andjon', 'андижон', 'андіжон', 'андижін', 'андижён', 'андиган', 'андигон', 'andigon', 'andigan', 'андижн', 'andizhan', 'андіжан', 'адижон', 'antijon', 'антижон', 'antijón', 'andijón', 'anjijon', 'анжонд', 'анджон', 'adijon', 'andij', 'анжан', 'анжанд', 'анжонга', 'anjang', 'anjan', 'анж'], lat: 40.7821, lng: 72.3442 },
  { name: "Farg'ona", aliases: ["farg'ona", 'фергана', 'фаргона', 'фарғона', 'fergana', 'fargona', 'фаргана', 'фарг', 'фарғ', 'фарғана', 'фарона', 'фаргано', 'фергона', 'fergona', 'фарғоно', 'фаргоно', 'парғона', 'паргона', 'фаргна', 'фергна', 'фарг\'она', 'водий', 'vodiy', 'forgona', 'форгона', 'forgano', 'форгано', 'фаргондан', 'фагона', 'фархона', 'fargandani', 'vodi', 'води', 'водї', "forg'on", 'форғон', 'forgon'], lat: 40.3834, lng: 71.7870 },
  { name: 'Namangan', aliases: ['namangan', 'наманган', 'намган', 'наманг', 'наман', 'номонгон', 'намонгон', 'намангон', 'namangon', 'наманган', 'наманґан', 'наманкан', 'намнган', 'наманг\'он', 'namagan', 'намаган', 'naman', 'наман', 'намангага', 'nomongon', 'намагада', 'намангада', 'намонгон'], lat: 40.9983, lng: 71.6726 },
  ...
  { name: 'Nukus', aliases: ['nukus', 'нукус', 'qaraqalpogiston', 'қарақалпоғистон', 'каракалпакстан', 'каракалпак', 'qaraqalpoq', 'karakalpak', 'каракалпакия', 'нукис', 'нокис', 'нокус', 'nukis', 'nokis', 'нўкус', 'нукуc', 'nukys', 'нукіс', 'қорақалпоғ', 'қорақалпоғистон', 'karakalpakstan', 'qoraqalpog\'iston', 'нукистен', 'нукустен', 'нукисдан', 'нукиска', 'нукуска', 'қорақолпоқ', 'каракалпог', 'qaroqolpoq', 'qaraqalpaq', 'коракалпок', 'қорақалпоқ', 'qoraqolpoq', 'нукс', 'nuks', 'нокс', 'нуксга', 'нукуска'], lat: 42.4628, lng: 59.6003 },
  { name: 'Urganch', aliases: ['urganch', 'ургенч', 'urgench', 'ўрганч', 'урганч', 'ургонч', 'ургенч', 'ургинч', 'urgonch', 'urginch', 'ургенч', 'ургенчь', 'ургенш', 'ўрғанч', 'urgach', 'ургач', 'уроанч', 'уроанчга', 'урганча', 'ургенча', 'ургончга', 'ўрганча'], lat: 41.5533, lng: 60.6336 },
  { name: 'Jizzax', aliases: ['jizzax', 'джизак', 'жиззах', 'жизза', 'jizzakh', 'жиззак', 'жиззақ', 'жизах', 'жиззох', 'jizzox', 'jizax', 'джизах', 'дизак', 'жиззаx', 'джіззак', 'жиззаҳ', 'jizzah', 'жиззаh', 'jizah', 'жизаh', 'жизах', 'жізах', 'jizzа', 'жизахт', 'жиззаг', 'jizaxx', 'жизахта', 'жизахга', 'жиззахлан'], lat: 40.1158, lng: 67.8422 },
  { name: 'Guliston', aliases: ['guliston', 'гулистон', 'гулистан', 'gulistan', 'гулстон', 'гулстан', 'гулістон', 'гулистон', 'гулистін', 'guliston', 'гулисан', 'гулістан', 'guluston', 'гулустон', 'гулустан', 'гулустон', 'гулисон', 'глустон', 'gulustion', 'gulistino', 'gulustino'], lat: 40.4897, lng: 68.7842 },

  // --- Toshkent viloyati ---
  { name: 'Sergeli', aliases: ['sergeli', 'сергели', 'сергили', 'серг', 'сергэли', 'сергелі', 'sergili', 'sergilik', 'сергилик'], lat: 41.2200, lng: 69.2200 },
  { name: 'Chirchiq', aliases: ['chirchiq', 'чирчик', 'chirchik', 'чирчиқ', 'чирчік', 'chirchik', 'чирчіқ', 'чирч', 'chirch', 'чирчек', 'чирчак', 'чирчир', 'chirchir', 'чирчікдан', 'chirchqdan'], lat: 41.4689, lng: 69.5828 },
  { name: 'Olmaliq', aliases: ['olmaliq', 'алмалык', 'almalyk', 'олмалиқ', 'олмалік', 'алмалик', 'олмалик', 'almalik', 'olmalik', 'алмалиқ', 'алмалық', 'альмалы', 'альмалыга'], lat: 40.8453, lng: 69.5983 },
  { name: 'Angren', aliases: ['angren', 'ангрен', 'ангрін', 'ohangaron', 'ангрэн', 'онгрен', 'angen', 'анген', 'ангін', 'angеn', 'ангирен', 'angiren', 'ангірен', 'angirin', 'ангирін', 'анггиренд', 'anggirendan', 'ангерен', 'ангерендан'], lat: 41.0167, lng: 70.1436 },
  ...
  { name: 'Bekobod', aliases: ['bekobod', 'бекабад', 'bekabad', 'bekabot', 'bekabod', 'бекобод', 'бекабот', 'бекобот', 'бекабід', 'бекобат', 'бекобід', 'бекоbot', 'бекабод', 'bekobat', 'bekabat', 'bekobot', 'бекобад', 'bekobоd', 'bekabob', 'бекабоб', 'бекобоб', 'бикобот', 'бикоботдан', 'bekaobod', 'бекаобод'], lat: 40.2214, lng: 69.2692 },
  { name: 'Ohangaron', aliases: ['ohangaron', 'ахангаран', 'ahangaran', 'охонгарон', 'охангарон', 'oxongoron', 'oxongaron', 'oxangaron', 'оҳангарон', 'аhангаран', 'охонгорон', 'ahongaron', 'ohongaron', 'ахангоран', 'oxangoron', 'ohongoron', 'охонгорон', 'ахонгорон', 'охонгоронга', 'ohangrang', 'охангранг', 'оhангранг', 'ehonguzar', 'эхонгузар', 'ehonguzor', 'эхонгузор'], lat: 41.0667, lng: 69.6333 },
  { name: 'Yangiyul', aliases: ['yangiyul', 'янгиюль', "yangiyo'l", "yangiyo'l", 'янгійўл', 'янгійул', 'yangiyl', 'янгиюл', 'yangiyol', 'янгийўл', 'янгийул', 'yangiul', 'янгіюль', 'янги йол', 'yangi yol', 'янгийол', 'янгійол'], lat: 41.1158, lng: 69.0461 },
  ...
  { name: 'Piskent', aliases: ['piskent', 'пскент', 'pskent', 'пискент', 'пискенд', 'пискант', 'пискінт', 'piksent', 'пискент', 'писканга', 'piskenga'], lat: 41.0667, lng: 69.3500 },
  ...
  { name: 'Fud Siti', aliases: ['fud siti', 'fudsiti', 'футсити', 'фут сити', 'фуд сити', 'фудсити', 'fut siti', 'futciti', 'фот сити', 'food sity', 'fodsiti', 'food city', 'foodcity', 'фотсити', 'фот сити', 'фуд сети', 'фут сети', 'fud seti', 'fut seti', 'food seti', 'fudseti', 'futsiti', 'foot sity', 'foot city'], lat: 41.2457, lng: 69.3478 },
  { name: 'Orikzor', aliases: ['orikzor', 'орикзор', 'оріқзор', 'orikzorbozor'], lat: 41.0000, lng: 69.6000 },
  { name: 'Kamchiq', aliases: ['kamchiq', 'камчик', 'камчиқ', 'pereval', 'перевал', 'первал', 'перивал', 'kamchik'], lat: 41.0500, lng: 70.4000 },
  { name: 'Ark Buloq', aliases: ['ark buloq', 'аркбулоқ', 'арк булоқ', 'арк булок', 'arkbuloq'], lat: 41.3000, lng: 69.2500 },

  // --- Andijon viloyati ---
  { name: 'Asaka', aliases: ['asaka', 'асака', 'ассака', 'assaka', 'осака', 'osaka', 'асока', 'асако', 'асақа'], lat: 40.6406, lng: 72.2378 },
  { name: "Xo'jaobod", aliases: ["xo'jaobod", 'ходжаабад', 'khodjaabad', 'xojaobod', 'хўжаобод', 'хўжаабад', 'хожаобод', 'хожаабад', 'xojaobot', 'хўжаобот', 'хожаобот', 'ходжаабат', 'xo\'jaobot', 'хўжообод', 'khojaobod', 'khojaabad', 'xujabot', 'xujabod', 'хужабод', 'хужабот', 'хўжабод', 'хўжабот', 'xujobot', 'xujobod', 'xojabod', 'хожабод', 'хўжабад'], lat: 40.6833, lng: 72.0333 },
  ...
  { name: 'Sadoqat', aliases: ['sadoqat', 'садоқат', 'садокат', 'sadoqatdan'], lat: 40.6333, lng: 72.2500 },

  // --- Farg'ona viloyati ---
  { name: "Qo'qon", aliases: ["qo'qon", 'коканд', 'kokand', 'quqon', 'кукон', 'куқон', 'кўқон', 'қўқон', 'қоқон', 'kokon', 'qqon', 'кокан', 'куқон', 'коқон', 'кокинд', 'қўқан', 'кўқан', 'коканда', 'кокант', 'коқанд', 'qoqon', 'qoqan', 'quqan', 'koqon', 'koqan', 'kukon', 'kukон', 'кокон', 'қуқон', 'қуқан', 'koqond', 'кокон', 'qoqona', 'qoqnda', 'куконша', 'кукан', 'кокондан', 'кўқондан', 'qiqon', 'қиқон', 'кикон', 'кикан', 'qiqan'], lat: 40.5286, lng: 70.9425 },
  { name: "Marg'ilon", aliases: ["marg'ilon", 'маргилан', 'маргилон', 'марғилон', 'margilan', 'margilon', 'маргілон', 'маргелан', 'margelan', 'маргілан', 'маргін', 'марг', 'марғ', 'маргиілон', 'маргілон', 'маргилін', 'margulon', 'маргулон', 'маргланга', 'маргглон', 'marglon', 'мафгиллон'], lat: 40.4703, lng: 71.7147 },
  ...
  { name: 'Beshariq', aliases: ['beshariq', 'бешарик', 'besharik', 'бешариқ', 'бешарық', 'бешорик', 'бішарік', 'бешарік', 'бишарик', 'бешарка', 'besharqa', 'бешарқа'], lat: 40.4500, lng: 70.5667 },
  ...
  { name: 'Yozyovon', aliases: ['yozyovon', 'язъяван', 'yazyavan', 'ёзёвон', 'язяван', 'язявон', 'ёзявон', 'yozyavan', 'язяван', 'ёзёвон', 'ёзёвін', 'йозйовон', 'язявін', 'yazyavon', 'язявон', 'язавон', 'язавондан', 'yazavon', 'yazavondan', 'йазавон', 'йозовон'], lat: 40.6667, lng: 71.7333 },
  ...
  { name: 'Quvasoy', aliases: ['quvasoy', 'кувасой', 'кувасай', 'kuvasoy', 'куваcой', 'кувасої', 'kuvosoy', 'кувосой', 'кувасой', 'quvasay', 'kuvasay', 'quvosoy', 'кувосой'], lat: 40.3028, lng: 71.6833 },
  ...
  { name: 'Chuqursoy', aliases: ['chuqursoy', 'чуқурсой', 'чукурсой', 'chuqursay', 'чуқурсай'], lat: 41.0800, lng: 70.0500 },
  ...
  { name: 'Kosonsoy', aliases: ['kosonsoy', 'касансай', 'kasansay', 'косонсой', 'касансой', 'косансой', 'кассансай', 'касонсой', 'kosonsay', 'касансоі', 'касонсай', 'кассонсой', 'касонсой', 'косансой'], lat: 41.2350, lng: 71.5400 },
  ...
  { name: "Uchqo'rg'on", aliases: ["uchqo'rg'on", 'учкурган', 'uchqorgon', 'uchkurgan', 'учқўрғон', 'учқоргон', 'учкургон', 'учкўрғон', 'учқоргон', 'uchkurgon', 'учкурғон', 'учкургін', 'учқўрғін', 'учкоргон', 'uchkorgon'], lat: 41.1167, lng: 71.0500 },
  { name: 'Axcha', aliases: ['axcha', 'ахча', 'ахчадан', 'axchadan', 'акча', 'akchadan'], lat: 41.0500, lng: 71.2500 },
  { name: 'Jomashuy', aliases: ['jomashuy', 'жомашуй', 'жомашўй', 'jomashoy', 'жомошуй'], lat: 41.1500, lng: 71.0000 },
  ...
  // --- Samarqand viloyati ---
  { name: 'Kattaqorgon', aliases: ['kattaqorgon', 'каттакурган', 'kattakurgan', 'каттақўрғон', 'каттакоргон', 'каттақоргон', 'каттакургон', 'каттақургон', 'каттақўрғін', 'каттакурғон', 'каттакоргін', 'kattakurgon', 'kattaqurgon', 'каттакўрғон', 'қаттақўрғон', 'каттақорғон', 'kataqurgon', 'катақурғон', 'катакургон', 'katakurgon', 'kattaquron', 'каттақурон', 'каттакурон', 'kattakuron', 'каттакуран', 'каттакўрон', 'kattaqurон', 'katqorgon', 'каткоргон', 'катқоргон', 'katqorgonga'], lat: 39.9000, lng: 66.2567 },
  { name: 'Urgut', aliases: ['urgut', 'ургут', 'ургуд', 'ўргут', 'ургат', 'ургіт', 'ургут', 'urgud', 'ургўт', 'urgur'], lat: 39.4000, lng: 67.2333 },
  { name: "Bulung'ur", aliases: ["bulung'ur", 'булунгур', 'bulungur', 'булунғур', 'булуңғўр', 'булуңгур', 'булонгур', 'булунгір', 'булунғір', 'булінгур', 'булуngur', 'булнгир', 'булнґир', 'булнгур', 'bulungor', 'булунгор', 'bulunfur', 'булунфур', 'булунфір', 'bulingir', 'булинғир', 'булінґурдан', 'булунгирдан'], lat: 39.7667, lng: 67.2667 },
  { name: 'Toyloq', aliases: ['toyloq', 'тойлок', 'taylak', 'тойлоқ', 'тойлак', 'тайлок', 'тойлік', 'toyloq', 'тойлок', 'тойлоқ', 'tayloqdan'], lat: 39.5167, lng: 67.1833 },
  { name: 'Ishtixon', aliases: ['ishtixon', 'иштихан', 'ishtikhan', 'иштиҳон', 'иштихон', 'іштіхон', 'иштіхон', 'иштихін', 'иштехон', 'ishtihon', 'иштихан', 'иштихён', 'иштхон', 'ishtxon'], lat: 39.9167, lng: 66.5333 },
  { name: 'Jomboy', aliases: ['jomboy', 'джамбай', 'jambay', 'жомбой', 'жомбай', 'джамбой', 'жамбай', 'жомбой', 'жомбій', 'жамбой', 'жамбій', 'джамбої', 'jonboy', 'жонбой', 'жонбай', 'jamboy', 'жамбой', 'жонбойдан'], lat: 39.7167, lng: 67.1833 },
  { name: 'Chelak', aliases: ['chelak', 'челак', 'чилак', 'чилек', 'chelek'], lat: 39.4500, lng: 67.3500 },
  { name: 'Usmat', aliases: ['usmat', 'усмат', 'усмад', 'ўсмат', 'усмот', 'усматдан', 'усматга'], lat: 40.0833, lng: 67.8333 },
  { name: 'Narpay', aliases: ['narpay', 'нарпай', 'нарпой', 'нарпій', 'нарпей', 'нарпой', 'нарпай', 'нарпій'], lat: 39.9167, lng: 66.5833 },
  ...
  { name: 'Oqdaryo', aliases: ['oqdaryo', 'акдарья', 'akdarya', 'оқдарё', 'оқдарья', 'акдарё', 'oqdare', 'акдаря', 'оқдаря', 'оқдарьо', 'акдарє', 'акдарьо', 'акдарьо'], lat: 39.6167, lng: 67.0333 },
  { name: 'Sazagan', aliases: ['sazagan', 'сазаган', 'сазоган'], lat: 39.5200, lng: 67.5000 },
  { name: "Pastdarg'om", aliases: ["pastdarg'om", 'пастдаргом', 'pastdargom', 'пастдарғом', 'постдаргом', 'пастдаргам', 'пастдарғам', 'пастдарғім', 'пастдаргім', 'пасдаргом', 'pastdarg\'om', 'пастаргом', 'pastargom', 'пастарг'], lat: 39.5667, lng: 66.7167 },
  ...
  { name: 'Jartepa', aliases: ['jartepa', 'жартепа', 'жартепо', 'жартіпа', 'жартепога'], lat: 39.8000, lng: 67.3000 },
  ...
  { name: 'Romitan', aliases: ['romitan', 'ромитан', 'ромитон', 'ромітан', 'ромітон', 'ромитін', 'румитан', 'romitón', 'ромитан', 'рометан', 'рометандан', 'rometan'], lat: 39.9333, lng: 64.3833 },
  ...
  { name: 'Vobkent', aliases: ['vobkent', 'вабкент', 'вобкент', 'вобкенд', 'вабкенд', 'вобкінт', 'вабкінт', 'вобкант', 'вабкант', 'вобкент', 'вобкент', 'вопкент', 'вопкентга'], lat: 40.0333, lng: 64.5167 },
  ...
  { name: 'Qorovulbozor', aliases: ['qorovulbozor', 'каракуль', 'karakul', 'qoravulbozor', 'қоровулбозор', 'коровулбозор', 'каравулбазар', 'коравулбозор', 'қоравулбозор', 'коровулбазар', 'каравулбозор', 'qorovulbazar', 'караулбозор', 'каравулбозор', 'караулбазар', 'karaulbozor', 'karaulbazar'], lat: 39.5833, lng: 64.2000 },
  { name: "Qorako'l", aliases: ["qorako'l", 'каракуль', 'qorakol', 'қоракўл', 'қоракол', 'коракол', 'коракўл', 'каракул', 'коракул', 'қорокўл', 'караколь', 'коракуль', "qarako'l", 'qarakol', 'қаракўл', 'қаракол', 'каракол', 'караколь', "korako'l", 'korakol', "karako'l", 'karakol', 'коракўл'], lat: 39.5167, lng: 63.8500 },

  // --- Navoiy viloyati ---
  { name: 'Zarafshon', aliases: ['zarafshon', 'зарафшан', 'zarafshan', 'зарафшон', 'зарофшон', 'зарафшін', 'зарафшон', 'заравшон', 'заравшан', 'заруфшон', 'zaravshon', 'zaravshan', 'зарафшін', 'зарафшін', 'заруфшон', 'zarafwon', 'заrafwon', 'zarafwlon'], lat: 41.5750, lng: 64.1850 },
  ...
  { name: 'Gasgan', aliases: ['gasgan', 'газган', 'ғазган', 'газгон', 'газгандан', 'gazgan', 'ғозган', 'газгондан'], lat: 40.5100, lng: 64.6800 },

  // --- Qashqadaryo viloyati ---
  { name: 'Shahrisabz', aliases: ['shahrisabz', 'шахрисабз', 'shaxrisabz', 'шаҳрисабз', 'шахрісабз', 'шахрисабс', 'шахрісабс', 'shahrisabs', 'шахрисобз', 'шаҳрисобз', 'шахрисабіз', 'шахрисавз', 'шахрісобз', 'шахрисабез', 'шахрісабез', 'shahrisabez', 'shaxrisabez', 'shaxrisabiz', 'шахрисабиз', 'шахрсабз', 'шарсабз', 'shahrizabs', 'sharsabiz', 'шахрсабіз', 'шахрісобздан', 'shahrisabizda', 'шахрсабздан'], lat: 39.0547, lng: 66.8297 },
  { name: 'Kitob', aliases: ['kitob', 'китаб', 'kitab', 'ктоб', 'китоб', 'кітоб', 'кітаб', 'кітоб', 'китап', 'китоп', 'kітob', 'китід', 'kitop', 'китов', 'kitov'], lat: 39.1331, lng: 66.8578 },
  ...
  { name: "G'uzor", aliases: ["g'uzor", 'гузар', 'guzor', 'guzar', 'ғузор', 'ғузар', 'гузір', 'ғузір', 'гузер', 'ғузер', 'гўзор', 'ғўзор', 'гузор', 'кузор', 'кузар', 'гизор', 'гізор', 'gizor'], lat: 38.6167, lng: 66.2500 },
  ...
  { name: 'Dehqonobod', aliases: ['dehqonobod', 'дехканабад', 'dehkanabad', 'дехконобод', 'дехканабот', 'дехканобод', 'деҳқонобод', 'деҳқонобот', 'дехконобот', 'дехканабод', 'дехканобот', 'dehqonobot', 'дехқонобод', 'дехқонобот', 'дехконабод', 'дехконабат', 'dehkonobod', 'dehkonabad', 'деконобот', 'дехкабот', 'dexqabot', 'декабот', 'декаботга', 'dexqanabotga', 'деконобод', 'деконобот', 'dekоnobod'], lat: 38.3500, lng: 66.5000 },
  ...
  { name: 'Kasbi', aliases: ['kasbi', 'касби', 'қасби', 'касбі', 'қасбі', 'касбий', 'қасбий', 'касбій'], lat: 38.9500, lng: 65.4500 },
  { name: 'Qashqadaryo', aliases: ['qashqadaryo', 'кашкадарья', 'кашкадарё', 'қашқадарё', 'kashkadarya', 'кашкадар', 'қашқадарьо', 'кашкадарьо', 'кашкадір', 'қашқадаря', 'кошқадарё', 'кашкадарья', 'қошқадарё', 'кашкадарё', 'кашкадарйо', 'кашкадарега', 'кашкадарйога', 'кашкадарийо', 'kashqadaryo', 'qashqadariya', 'кошкадарья', 'кашкадаре', 'кашкадарьога', 'кашкадареога', 'кашкадарео', 'кашқадарё', 'qashqadarе', 'кашкадарйа', 'qashqadryo', 'кашкадрё', 'қашқадрё', 'кашкадрёо', 'кашкадрйо', 'qawqadaryo', 'qashaqadaryo', 'кашкадайро', 'кашкадарёдан', 'qashaqdary', 'қашақдарё', 'қашақдарёо', 'кашкадарёо', 'kashkadary'], lat: 38.8606, lng: 65.7981 },
  ...
  { name: 'Sangzar', aliases: ['sangzar', 'сангзор', 'сангзар'], lat: 39.9000, lng: 68.3500 },
  ...
  { name: 'Muzrobod', aliases: ['muzrobod', 'музрабод', 'музработ', 'muzrabad', 'мўзработ', 'музрабад', 'музробод', 'музробот', 'музрабат', 'музрабід', 'музробід', 'музробат', 'muzrobot', 'muzrabat', 'мўзробод', 'мўзрабод', 'muzrabot', 'музработ'], lat: 38.1833, lng: 67.4333 },
  { name: 'Oltinsoy', aliases: ['oltinsoy', 'алтынсай', 'altinsoy', 'олтинсой', 'алтинсой', 'олтинсай', 'олтінсой', 'алтынсой', 'олтинсій', 'алтинсай', 'олтинсай', 'олтінсой'], lat: 38.3333, lng: 67.6667 },
  ...
  // --- Jizzax viloyati ---
  { name: "G'allaorol", aliases: ["g'allaorol", 'галляарал', 'gallaorol', 'gallaaral', 'ғаллаорол', 'галлаорол', 'галлаарал', 'ғалаорол', 'галлаорол', 'ғаллаарал', 'gallaarol', 'галларол', 'ғалларол', 'галларолдан', 'галларол', 'галлярал'], lat: 40.4833, lng: 68.1167 },
  ...
  { name: 'Forish', aliases: ['forish', 'фариш', 'farish', 'фориж', 'фориш', 'форіш', 'фаріш', 'форіш', 'форишь', 'фариж', 'фариш', 'фориж', 'форижга', 'фориша', 'форіша'], lat: 40.3833, lng: 68.4500 },
  ...
  { name: 'Paxtachi', aliases: ['paxtachi', 'пахтачи', 'пахтачі', 'паxтачидан', 'pahtachi'], lat: 40.3167, lng: 67.9500 },
  ...
  { name: 'Ravot', aliases: ['ravot', 'равот', 'ровот', 'ravotga'], lat: 40.3500, lng: 68.4500 },
  { name: 'Qizilqum', aliases: ['qizilqum', 'кизилкум', 'қизилқум', 'кизилкумга'], lat: 40.5000, lng: 68.5000 },
  ...
  { name: 'Chodak', aliases: ['chodak', 'чодак', 'чадак', 'chadak', 'чадок', 'chodok'], lat: 40.0667, lng: 68.0333 },
  { name: 'Olmos', aliases: ['olmos', 'олмос', 'олмоз', 'альмос', 'ollmos'], lat: 40.3000, lng: 68.1000 },
  ...
  // --- Sirdaryo viloyati ---
  { name: 'Sirdaryo', aliases: ['sirdaryo', 'сырдарья', 'сирдарё', 'syrdarya', 'sirdarya', 'сирдарьо', 'сирдарья', 'сирдарё', 'сірдарё', 'сырдаря', 'сирдаря', 'сирдарьё', 'сирдорё', 'сырдарьо', 'сирдорьо', 'сирдарйо', 'сирдарйога', 'сирдаре', 'сирдарьога', 'сирдайо', 'sirdarе', 'сирдайё', 'сирдорья', 'сиржарйо', 'сирдрё', 'sirdsryo', 'sirsaryo', 'сирдаед', 'sirsary', 'siradry', 'срдарйо', 'срдорйо', 'сирдорйо', 'сіржарё', 'siradary', 'sirdary', 'sirdaro', 'сирдаро', 'сірдаро', 'сырдарьё', 'сырдарё', 'сырдарёга', 'сырдаръя', 'сирдарйога'], lat: 40.8500, lng: 68.6667 },
  { name: 'Boyovut', aliases: ['boyovut', 'баяут', 'bayavut', 'bayaut', 'boyavud', 'boyavut', 'бояуд', 'бояут', 'бойовут', 'бояўт', 'бояівут', 'бояуть', 'бояўд', 'boyovud', 'бойовуд', 'бойовід', 'байавут', 'байовут', 'баёвут', 'bayovut', 'bayavud', 'бойавут', 'бойовуд', 'баявут', 'боявуд'], lat: 40.3667, lng: 68.7833 },
  { name: 'Hovos', aliases: ['hovos', 'хавос', 'xovos', 'хавас', 'khavas', 'ҳовос', 'ховос', 'хавіс', 'ҳавос', 'хавос', 'ховас', 'ҳавас', 'хавас', 'hovos', 'ҳавос'], lat: 40.2500, lng: 68.9167 },
  ...
  { name: 'Begavot', aliases: ['begavot', 'бегавот', 'бегават', 'begavat', 'бегавід', 'бегавод', 'бегавут', 'begavut', 'бегабот', 'бегоботга', 'begabot', 'бегобот', 'begovot', 'беговот', 'беговат'], lat: 40.3800, lng: 68.7000 },
  ...
  { name: 'Hazorasp', aliases: ['hazorasp', 'хазарасп', 'hazarasp', 'ҳазорасп', 'хозорасп', 'хазарасп', 'хозорасп', 'хазарасб', 'ҳазарасп', 'хазороcп', 'хазарісп', 'хозарасп', 'xazarasb', 'хазарасб', 'хозарасб', 'хозораcб', 'хозарасп', 'хазарисп'], lat: 41.3333, lng: 61.0667 },
  ...
  { name: 'Mangit', aliases: ['mangit', 'манғит', 'мангит', 'mangit', 'мангт', 'манг\'ит', 'мангіт', 'мангід', 'mangut', 'мангут', 'монгет', 'монгіт', 'мангітдан', 'мангтдан'], lat: 42.1167, lng: 60.0667 },
  ...
  { name: 'Krasnodar', aliases: ['krasnodar', 'краснодар', 'крд', 'краснадар', 'krasnadar', 'краснадор', 'красндар'], lat: 45.0355, lng: 38.9753 },
  ...
  { name: 'Sayanogorsk', aliases: ['sayanogorsk', 'саяногорск', 'саянагорск', 'sayanagorsk'], lat: 53.1000, lng: 91.3900 },
  ...
  //                              BELARUS
  // =====================================================================================
  { name: 'Belarus', aliases: ['belarus', 'белорусь', 'белоруссия', 'беларусь', 'беларус', 'belorusiya', 'белорусия', 'билоруся', 'bilorusya', 'bilorusiya', 'билорусия', 'белоруся'], lat: 53.9045, lng: 27.5615 },
  ...
  { name: 'Polsha', aliases: ['polsha', 'польша', 'poland', 'полша', 'полш', 'polsh'], lat: 52.2297, lng: 21.0122 },
 ...
 */
function normalizeCyrLatHomoglyphs(text: string): string {
  ...
  const cyrCount = (text.match(/[а-яА-ЯўқғҳёЎҚҒҲЁ]/g) || []).length;
  if (latinCount <= cyrCount) return text; // Asosan kirill — almashtirilmaydi
  return text.replace(/[а-яА-Я]/g, ch => map[ch] || ch);
}
 ...
 */
function isWordBoundary(text: string, startIdx: number, endIdx: number): boolean {
  const letterRegex = /[a-zа-яўқғҳёіїєґ'0-9]/i;
...
const CITY_SUFFIXES = [
  ...
  'гача', 'нинг', 'даги',
  'нига', 'ника', 'нида', 'нидан', 'niga', 'nika', 'nida', 'nidan',
...
const _cityLookup = new Map<string, CityCoord>();

// Matndagi qidirish uchun — har shahar uchun searchable termlar
interface SearchTerm { term: string; city: CityCoord; minLen: number }
let _searchTerms: SearchTerm[] = [];

function _buildLookup() {
  if (_cityLookup.size > 0) return;

  for (const city of CITIES) {
    const normName = normalizeApostrophes(city.name).toLowerCase();
    const strippedName = stripApostrophes(normName);
    ...
    for (const alias of city.aliases) {
      const normAlias = normalizeApostrophes(alias);
      const strippedAlias = stripApostrophes(normAlias);
      const homoAlias = stripApostrophes(normalizeCyrLatHomoglyphs(normAlias));
      _cityLookup.set(normAlias, city);
      _cityLookup.set(strippedAlias, city);
      if (homoAlias !== strippedAlias) _cityLookup.set(homoAlias, city);
    }

    // Search termlar — matndagi qidirish uchun
    const allNames = [normName, ...city.aliases.map(a => normalizeApostrophes(a))];
    for (const name of allNames) {
      if (name.length < 3) continue;
      const nameStripped = stripApostrophes(name);
      _searchTerms.push({ term: name, city, minLen: name.length });
      if (nameStripped !== name) {
        _searchTerms.push({ term: nameStripped, city, minLen: nameStripped.length });
      }
    }
  }

  // Uzunroq termlarni birinchi qidirish (greedy match)
  _searchTerms.sort((a, b) => b.term.length - a.term.length);
}
 ...
 */
export function findCity(input: string): CityCoord | null {
  const lower = normalizeApostrophes(input).toLowerCase().trim();
  if (lower.length < 2) return null;

  // 1. Direct Map lookup — O(1)
  const direct = _cityLookup.get(lower) ?? _cityLookup.get(stripApostrophes(lower));
  if (direct) return direct;

  // 2. Homoglyph normalized
  const homo = stripApostrophes(normalizeCyrLatHomoglyphs(lower));
  const homoMatch = _cityLookup.get(homo);
  if (homoMatch) return homoMatch;

  // 3. Suffix stripping (homoglyph normalized ham sinab ko'riladi)
  const homoLower = stripApostrophes(normalizeCyrLatHomoglyphs(lower));
  const variants = homoLower !== homo ? [lower, homoLower] : [lower];
  for (const variant of variants) {
    for (const suffix of CITY_SUFFIXES) {
      if (variant.endsWith(suffix) && variant.length >= suffix.length + 2) {
        const base = variant.substring(0, variant.length - suffix.length);
        const m = _cityLookup.get(base) ?? _cityLookup.get(stripApostrophes(base));
        if (m) return m;
        // Undosh qo'shilishi: "samarqandan" → strip "dan" → "samarqan" + "d" → "samarqand"
        const baseWithFirst = base + suffix[0];
        const m2 = _cityLookup.get(baseWithFirst) ?? _cityLookup.get(stripApostrophes(baseWithFirst));
        if (m2) return m2;
        // Ikkilangan undosh: "намангангга" → base "наманганг", suf "га" → base[-1]==suf[0] → "наманган"
        if (base.length > 2 && base[base.length - 1] === suffix[0]) {
          const baseTrimmed = base.substring(0, base.length - 1);
          const m3 = _cityLookup.get(baseTrimmed) ?? _cityLookup.get(stripApostrophes(baseTrimmed));
          if (m3) return m3;
        }
      }
    }
...
const _textSuffixes = [
  // 3+ compound suffixlar (uzunroq — avval tekshiriladi)
  'данман', 'динман', 'донман', 'danman', 'dinman', 'donman',
  'дамиз', 'димиз', 'damiz', 'dimiz',
  'нига', 'ника', 'нида', 'нидан', 'нига', 'нидаги',
  'niga', 'nika', 'nida', 'nidan', 'nidagi',
  // 2-3 compound
  'даман', 'дан', 'дин', 'ден', 'дон', 'тан', 'тин', 'тон', 'га', 'ге', 'го', 'гача', 'нинг', 'даги', 'да', 'ни', 'ка', 'ча',
  'daman', 'dan', 'din', 'den', 'don', 'tan', 'tin', 'ton', 'ga', 'ge', 'go', 'qa', 'gacha', 'ning', 'dagi', 'da', 'ni', 'ka', 'cha',
];

// So'zdan suffix olib tashlash va _cityLookup dan qidirish
function _lookupWord(word: string): CityCoord | null {
  // Direct lookup
  let city = _cityLookup.get(word);
  if (city) return city;

  // Stripped apostrophes
  const stripped = stripApostrophes(word);
  if (stripped !== word) {
  ...
  const homoWord = stripApostrophes(normalizeCyrLatHomoglyphs(word));
  ...
  const wordsToTry = homoWord !== word && homoWord !== stripped ? [word, homoWord] : [word];
  for (const w of wordsToTry) {
    for (const suf of _textSuffixes) {
      if (w.length >= suf.length + 2 && w.endsWith(suf)) {
        const base = w.substring(0, w.length - suf.length);
        city = _cityLookup.get(base);
        if (city) return city;
        const baseStripped = stripApostrophes(base);
        if (baseStripped !== base) {
          city = _cityLookup.get(baseStripped);
          if (city) return city;
        }
        // Undosh qo'shilishi: "samarqandan" → strip "dan" → "samarqan" + "d" → "samarqand"
        const baseWithFirstChar = base + suf[0];
        city = _cityLookup.get(baseWithFirstChar);
        if (city) return city;
        const baseWithFirstStripped = stripApostrophes(baseWithFirstChar);
        ...
        if (base.length > 2 && base[base.length - 1] === suf[0]) {
          ...
          if (city) return city;
          const baseTrimmedStripped = stripApostrophes(baseTrimmed);
 ...
 */
export function findCitiesInText(text: string): CityCoord[] {
  _buildLookup();
  ...
  const textLower = normalizeApostrophes(text).toLowerCase()
    .replace(/[-–—_/\\|.]+/g, ' ')
  ...
  const found: { city: CityCoord; index: number; tokenLen: number }[] = [];
  const usedNames = new Set<string>();

  // Matnni so'zlarga bo'lish
  const wordRegex = /[a-zа-яўқғҳёіїєґ0-9'''ʻ]+/gi;
  ...
  for (let i = 0; i < tokens.length; i++) {
    ...
    if (!city && i + 1 < tokens.length && tokens[i + 1].idx - idx - word.length <= 2) {
      ...
      if (!city && i + 2 < tokens.length) {
        const threeWord = twoWord + tokens[i + 2].word;
        city = _lookupWord(threeWord);
      }
    }

    if (city && !usedNames.has(city.name)) {
      found.push({ city, index: idx, tokenLen: word.length });
  ...
  const filtered: { city: CityCoord; index: number; tokenLen: number }[] = [];
  for (let i = 0; i < found.length; i++) {
    if (i + 1 < found.length && _VILOYAT_NAMES.has(found[i].city.name)) {
      ...
      const nameLen = found[i].city.aliases[0]?.length || found[i].city.name.length;
      const hasSuffix = found[i].tokenLen > nameLen + 1;
      if (!hasSuffix) {
        const dist = haversineKm(
          found[i].city.lat, found[i].city.lng,
          found[i + 1].city.lat, found[i + 1].city.lng,
        );
        if (dist < 150) {
  ...
  return filtered.map(f => f.city);
}

// Viloyat nomlari — kontekst sifatida tushib qolishi mumkin
const _VILOYAT_NAMES = new Set([
 ...
 */
export function calculateDistance(from: string, to: string): number | null {
  const cityFrom = findCity(from);
  const cityTo = findCity(to);

  if (!cityFrom || !cityTo) return null;
  if (cityFrom.name === cityTo.name) return 0;
