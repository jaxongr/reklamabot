...
process.on('unhandledRejection', function (reason) {
    var msg = (reason === null || reason === void 0 ? void 0 : reason.message) || String(reason);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.sent();
                    console.log("\n\uD83D\uDE80 Application is running on: http://localhost:".concat(port, "\n\uD83D\uDCDA API Documentation: http://localhost:").concat(port, "/api/docs\n\uD83D\uDD11 JWT Secret: ").concat(process.env.JWT_SECRET ? '✓ Configured' : '✗ Missing', "\n\uD83D\uDDC4 Database: ").concat(process.env.DATABASE_URL ? '✓ Configured' : '✗ Missing', "\n\uD83E\uDD16 Telegram Bot: ").concat(process.env.TELEGRAM_BOT_TOKEN ? '✓ Configured' : '✗ Missing', "\n  "));
                    return [2 /*return*/];
            }
        });
    });
